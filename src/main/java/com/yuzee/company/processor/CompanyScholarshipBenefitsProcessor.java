...
@Service
@Slf4j
public class CompanyScholarshipBenefitsProcessor {
	...
	@Transactional
	public CompanyScholarshipGenericDto addUpdateCompanyScholarshipBenefits(String userId , String companyId, String companyScholarshipId, CompanyScholarshipGenericDto companyScholarshipGenericDto) throws NotFoundException, UnauthorizeException, BadRequestException {
		log.debug("Inside CompanyScholarshipBenefitsProcessor.addUpdateCompanyScholarshipBenefits() method");
		...
		log.info("Adding benefits description for company scholarship id {}",companyScholarshipId);
		companyScholarship.setBenefits(companyScholarshipGenericDto.getDescription());
	...
	@Transactional
	public CompanyScholarshipGenericDto getCompanyScholarshipBenefits(String userId , String companyId ,String companyScholarshipId) throws NotFoundException {
		log.debug("Inside CompanyScholarshipBenefitsProcessor.getCompanyScholarshipBenefits() method");
		log.info("Getting company with companyId {}", companyId);
		Optional<Company> optionalCompany = companyDao.getCompanyById(companyId);
		...
		return new CompanyScholarshipGenericDto(companyScholarship.getBenefits());
	}
