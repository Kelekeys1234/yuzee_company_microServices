...
public class CompanyScholarshipConditionProcessor {
	...
	@Transactional
	public CompanyScholarshipGenericDto addUpdateCompanyScholarshipCondition(String userId , String companyId, String companyScholarshipId, CompanyScholarshipGenericDto companyScholarshipGenericDto) throws NotFoundException, UnauthorizeException {
